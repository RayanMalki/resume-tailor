...
func buildCoverLetterPrompt(resumeText, jobText string, bm25Signals any, lang string, disciplineCtx DisciplineContext) string {
	...
	b.WriteString("LANGUAGE: All output must be in " + lang + ". Use exactly one language for the entire letter.\n")
	...
	b.WriteString("- Output ONLY the body paragraphs. No addressee block.\n")
	b.WriteString("- Do NOT include salutations (e.g., Dear Hiring Manager, Madame, Monsieur).\n")
	b.WriteString("- Do NOT include complimentary closes/signatures (e.g., Sincerely, Cordialement, candidate name).\n")
